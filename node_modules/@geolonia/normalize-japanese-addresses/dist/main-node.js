    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 5:
                ...
                addrs.sort(function (res1, res2) { return res2.addr.length - res1.addr.length; });
                ...
                case 7:
                    ...
                    if (town) {
                        addr = addr
                            ...
                            .replace(/([0-9]+|[〇一二三四五六七八九十百千]+)[-－﹣−‐⁃‑‒–—﹘―⎯⏤ーｰ─━]/g, function (match) {
                            return kan2num(match).replace(/[-－﹣−‐⁃‑‒–—﹘―⎯⏤ーｰ─━]/g, '-');
                        })
                            .replace(/[-－﹣−‐⁃‑‒–—﹘―⎯⏤ーｰ─━]([0-9]+|[〇一二三四五六七八九十百千]+)/g, function (match) {
                            return kan2num(match).replace(/[-－﹣−‐⁃‑‒–—﹘―⎯⏤ーｰ─━]/g, '-');
                        })
